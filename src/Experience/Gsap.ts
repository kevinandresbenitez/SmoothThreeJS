...
export class Gsap {
    ...
    addScrollAnimation() {
        ...
        const itemsAnimation = this.mainExperience.resources.getModelItems();
    ...
    addMediaQuerysScene() {
        if (!this.mainExperience.resources.getModel()) {
            console.warn('models not are loaded for mediaQuerys')
        }
        const model = this.mainExperience.resources.getModel();
    ...
    setAnimationMouseMove() {
        const mouseMove = (event: any) => {
            ...
            this.mainExperience.resources.getModel().rotation.y = rotation
        }
    ...
    async startFirstAnimation(): Promise<Boolean> {
        ...
        const Cube = this.mainExperience.resources.getModelItems().Cube;
